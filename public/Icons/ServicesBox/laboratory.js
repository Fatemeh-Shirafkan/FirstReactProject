...
const SVGComponent = (props) => (
  ...
  >
    ...
    <g>
      <g>
        <g>
          <path className="st0" d="M100,6.7" />
          <path className="st0" d="M100,13.3" />
          <path className="st0" d="M100,20" />
          <path className="st0" d="M100,26.7" />
          <path className="st0" d="M100,33.3" />
          <path className="st0" d="M100,40" />
          <path className="st0" d="M100,46.7" />
          <path className="st0" d="M100,53.3" />
          <path className="st0" d="M100,60" />
          <path className="st0" d="M100,66.7" />
          <path className="st0" d="M100,73.3" />
          <path className="st0" d="M100,80" />
          <path className="st0" d="M100,86.7" />
          <path className="st0" d="M100,93.3" />
          <path className="st0" d="M100,100" />
        </g>
        <path className="st1" d="M100,6.7" />
        <path className="st1" d="M100,93.3" />
      </g>
    </g>
